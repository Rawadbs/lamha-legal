...
- تتم عمليات الدفع عبر متجر التطبيق (App Store أو Google Play).
...
- الإساءة أو التنمر أو خطاب الكراهية.
- نشر محتوى غير لائق أو مخالف للشريعة الإسلامية أو أنظمة المملكة العربية السعودية.
- انتحال شخصية الآخرين.
- استغلال أخطاء تقنية (Bug Exploiting).
- استخدام برامج غش أو تهكير.
...
- المحتوى المخالف للشريعة أو أنظمة المملكة.
- التحرش.
- مشاركة معلومات شخصية.

يتحمل المستخدم كامل المسؤولية عن محتوى رسائله.  
يحق لإدارة اللعبة مراقبة الرسائل لأغراض السلامة.  
يمكن الإبلاغ عن أي إساءة عبر نظام الإبلاغ داخل اللعبة.

آلية الرقابة:

- نظام فلترة تلقائي للكلمات.
- إمكانية الإبلاغ داخل اللعبة.
- مراجعة بشرية للحالات الخطيرة.
- كتم فوري (Mute).
...
- Hate speech or discriminatory content based on race, religion, nationality, gender, or ethnicity.
- Political or sectarian content.
- Content that violates Islamic values or the laws and regulations of the Kingdom of Saudi Arabia.
- Harassment, bullying, or intimidation of any kind.
- Sharing personal or sensitive information (including phone numbers, addresses, social media accounts, or financial details).
